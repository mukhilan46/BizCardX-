...
icon = Image.open("C:\\Users\\STARK\\OneDrive\\Desktop\\business_card_home.png")
st.set_page_config(page_title="BizCardX: Extracting Business Card Data with OCR | By MUKILAN ELANCHEZHIAN",
                   page_icon=icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This OCR app is created by *MUKILAN ELANCHEZHIAN*!"""})
...
if selected == "Home":
    ...
    with col1:
        st.image(Image.open("C:\\Users\\STARK\\OneDrive\\Desktop\\business_card_home.png"), width=500)
